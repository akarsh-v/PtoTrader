...
$( document ).ready(function() {
	...
	if( $('#ct_chart_4').length > 0 ){
		new Chartist.Bar('#ct_chart_4',{
			labels: ['0-3km', '3-5km', '5-10km', '10-15km', '15-20','20+km'],
			  series: [
	...
	if( $('#ct_chart_41').length > 0 ){
		new Chartist.Bar('#ct_chart_41',{
			labels: ['0-10min', '10-20min', '20-30min', '30-40min', '40-50min','50-60min','1hr +'],
			  series: [
