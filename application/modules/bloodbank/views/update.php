		...
		<div class="panel-wrapper collapse in">
			<div class="panel-body">
				...
				<?php foreach($doctors as $d){ ?>
					<form action="<?=site_url(); ?>/bloodbank/updateaction" method="post" enctype="multipart/form-data" id="123">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" required name="name" value="<?=$d['institue_name']; ?>" id="firstName" class="form-control" placeholder="">
								</div>
							</div>
							<!--/span-->
							<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group dropdown">
									...
									<input  type="text" value="<?=$d['city']; ?>" required id="city" name="city" class="form-control dropdown-toggle" data-toggle="dropdown">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" required onclick="getloc('asdf');" name="location" value="<?=$d['location']; ?>" id="firstName" class="form-control" placeholder="">
								</div>
							</div>
							<!--/span-->
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input value="<?=$d['email']; ?>" type="email" required required id="" name="email" class="form-control" placeholder="">
								</div>
							</div>
							<!--/span-->
							<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea name="about" required class="form-control" rows="4"><?=$d['email']; ?></textarea>
								</div>
							</div>
						</div>
						<!--/row-->
						...
						<div class="row">
							<div class="col-lg-12">
							    <input type="hidden" name="oldimg" value="<?=$d['image']; ?>">
								<input type="hidden" name="id" value="<?=$d['id']; ?>">
								<div class="img-upload-wrap">
									<img class="img-responsive" src="<?=base_url(); ?><?=$d['image']; ?>" alt="upload_img"> 
								</div>
