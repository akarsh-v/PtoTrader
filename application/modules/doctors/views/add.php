				...
				<div class="form-wrap">
					<form action="<?=site_url(); ?>/doctors/add" method="post" enctype="multipart/form-data" id="123">
									...
									<div class="radio-list">
										<div class="radio-inline pl-0">
											<div class="radio radio-info">
												<input type="radio" required name="bni" id="radio1" value="1">
												<label for="radio1">Yes</label>
											</div>
										</div>
										<div class="radio-inline">
											<div class="radio radio-info">
												<input type="radio" required name="bni" id="radio2" value="0">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" required name="experiance" class="form-control" id="exampleInputuname" placeholder="">
									</div>
								</div>
							</div>
							<!--/span-->
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="input-group dropdown">
										...
										<input  type="text" required id="specialization" name="specialization" class="form-control dropdown-toggle" data-toggle="dropdown">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group dropdown">
									...
									<input  type="text" required id="college" name="college" class="form-control dropdown-toggle" data-toggle="dropdown">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
								    <label class="control-label mb-10">Certificate Number</label>
